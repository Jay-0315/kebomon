...
| 획득 방법   | 스타터 선택 / 업적 달성 / 가챠 / 알 부화 / 탐험 / 레이드            |
...
- 알 종류 3종 — 일반 알 / 빅 알 / 황금 알 (탐험·레이드·로그라이크 등에서 획득)
...
- 탐험 완료 시 보상 수령 — 포인트, 강화석, 알 (지역·난이도·파티 수·시간에 따라 산출)
- 동시에 1개 원정만 진행 가능, 진행 중 남은 시간 실시간 표시

### 레이드 탭

- 보스 레이드 4종 (타입 1·3·4·5) — 공동 참여로 보스 HP 소진
- 보스 처치 시 알 보상 지급
- WebSocket 실시간 로비 인원·HP 공유, 토벌 랭킹 확인
- 알 보유 현황 표시 및 알 부화 바로 실행

### 콜로세움 탭

- 1:1 실시간 PvP 배틀 (WebSocket, 주사위 기반 턴제)
- 티어 시스템 6단계 — 실버 / 골드 / 플레티넘 / 다이아몬드 / 마스터 / 챌린저
