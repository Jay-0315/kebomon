...
export type ApiErrorCode =
  ...
  | "REWARD_INVALID_PRODUCT"
  | "REWARD_INVALID_QUANTITY"
  | "GACHA_NOT_ENOUGH_POINTS"
  | "GACHA_INVALID_EGG"
  | "GACHA_NOT_ENOUGH_EGGS"
  | "GACHA_INVALID_BATCH_COUNT"
  | "BREED_INVALID_RARITY"
  | "BREED_NOT_ENOUGH_ESSENCE"
  | "BREED_ALL_OWNED";
