...
export const TITLES: TitleDef[] = [
  ...
  // ── 시즌 랭킹 칭호 (한정) ──
  { id: 43, name: "시즌1 top1",  grade: "limited",   conditionType: "season_rank", conditionValue: 1,     description: "시즌 1 최종 1위 달성",    hidden: true, variant: "season_neon" },
  { id: 44, name: "시즌1 top2",  grade: "limited",   conditionType: "season_rank", conditionValue: 2,     description: "시즌 1 최종 2위 달성",    hidden: true, variant: "season_neon" },
  { id: 45, name: "시즌1 top3",  grade: "limited",   conditionType: "season_rank", conditionValue: 3,     description: "시즌 1 최종 3위 달성",    hidden: true, variant: "season_neon" },
  { id: 46, name: "시즌1 top10", grade: "limited",   conditionType: "season_rank", conditionValue: 10,    description: "시즌 1 최종 TOP 10 달성", hidden: true, variant: "season_neon" },
  { id: 58, name: "시즌2 top1",  grade: "limited",   conditionType: "season_rank", conditionValue: 1,     description: "시즌 2 최종 1위 달성",    hidden: true, variant: "season_fire" },
