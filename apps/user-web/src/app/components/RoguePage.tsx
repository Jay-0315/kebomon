...
const CARDS: CardDef[] = [
  ...
  // Warrior
  { id:"slash",        name:"베기",         nameJa:"斬り",              nameEn:"Slash",         cost:1,type:"attack",rarity:"common",   desc:"7 데미지",            descJa:"7ダメージ",           descEn:"Deal 7 damage",                   archetype:"warrior", damage:7 },
  ...
  { id:"shadow_step",  name:"그림자 보법",  nameJa:"影歩き",            nameEn:"Shadow Step",   cost:2,type:"attack",rarity:"epic",     desc:"8 데미지 × 2, 에너지 +1, 드로우 1",descJa:"8ダメージ×2・エナジー+1・ドロー1",descEn:"Deal 8 damage twice, gain 1 energy, draw 1", archetype:"rogue", damage:8,multiHit:2,bonusEnergy:1,draw:1 },
  ...
  // Mage
  { id:"spark",        name:"마법 불꽃",    nameJa:"魔法の炎",          nameEn:"Spark",         cost:1,type:"attack",rarity:"common",   desc:"5 데미지, 독 1",      descJa:"5ダメージ・毒1",      descEn:"Deal 5 damage, apply 1 poison",   archetype:"mage",    damage:5,poison:1 },
  ...
  { id:"shell_crush",  name:"갑각 분쇄",    nameJa:"甲殻砕き",          nameEn:"Shell Crush",   cost:2,type:"attack",rarity:"epic",     desc:"10 데미지 × 2, 방어력 14",descJa:"10ダメージ×2・シールド14",descEn:"Deal 10 damage twice, gain 14 shield", archetype:"tank",    damage:10,multiHit:2,shield:14 },
  ...
  // Wild
  { id:"patch",        name:"응급 수리",    nameJa:"応急処置",          nameEn:"Patch",         cost:1,type:"skill", rarity:"common",   desc:"방어력 6, HP +5",     descJa:"シールド6・HP+5",     descEn:"Gain 6 shield, heal 5 HP",        archetype:"wild",    shield:6,heal:5 },
  ...
  { id:"phantom_dance",  name:"환영 난무",   nameJa:"幻影乱舞",        nameEn:"Phantom Dance",  cost:3,type:"attack",rarity:"legendary",desc:"6 데미지 × 3, 드로우 2",       descJa:"6ダメージ×3・ドロー2",    descEn:"Deal 6 damage three times, draw 2",           archetype:"rogue",   damage:6,multiHit:3,draw:2 },
  { id:"ancient_growth", name:"고대의 성장", nameJa:"古代の成長",      nameEn:"Ancient Growth", cost:3,type:"skill", rarity:"legendary",desc:"HP +28, 독 10, 방어력 12",    descJa:"HP+28・毒10・シールド12", descEn:"Heal 28 HP, poison 10, gain 12 shield",       archetype:"nature",  heal:28,poison:10,shield:12 },
  { id:"omega_blast",    name:"오메가 블래스트",nameJa:"オメガブラスト",nameEn:"Omega Blast",    cost:3,type:"attack",rarity:"legendary",desc:"8 데미지 × 3, 에너지 +1",     descJa:"8ダメージ×3・エナジー+1", descEn:"Deal 8 damage three times, gain 1 energy",    archetype:"wild",    damage:8,multiHit:3,bonusEnergy:1 },
];
