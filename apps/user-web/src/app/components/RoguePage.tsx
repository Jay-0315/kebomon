...
const CARDS: CardDef[] = [
  ...
  },
  {
    ...
    desc: "8 데미지, 에너지 +1",
    descJa: "8ダメージ・エナジー+1",
    descEn: "Deal 8 damage, gain 1 energy",
    archetype: "rogue",
    damage: 8,
    bonusEnergy: 1,
  },
  {
    ...
    type: "attack",
    rarity: "epic",
    desc: "8 데미지 × 2, 에너지 +1, 드로우 1",
    descJa: "8ダメージ×2・エナジー+1・ドロー1",
    descEn: "Deal 8 damage twice, gain 1 energy, draw 1",
    archetype: "rogue",
    damage: 8,
    multiHit: 2,
    bonusEnergy: 1,
  ...
  // Mage
  {
    ...
    desc: "5 데미지, 독 1",
    descJa: "5ダメージ・毒1",
    descEn: "Deal 5 damage, apply 1 poison",
    archetype: "mage",
    damage: 5,
    poison: 1,
  },
  {
    ...
    desc: "10 데미지, HP +5",
    descJa: "10ダメージ・HP+5",
    descEn: "Deal 10 damage, heal 5 HP",
    archetype: "mage",
    damage: 10,
    heal: 5,
  },
  ...
  },
  {
    ...
    rarity: "epic",
    desc: "10 데미지 × 2, 방어력 4",
    descJa: "10ダメージ×2・防御力4",
    descEn: "Deal 10 damage twice, gain 4 armor",
    archetype: "tank",
    damage: 10,
    multiHit: 2,
    shield: 4,
  ...
  // Nature (healing & max-HP scaling)
  {
    ...
    desc: "최대HP의 15% 데미지",
    descJa: "最大HPの15%ダメージ",
    descEn: "Deal 15% of max HP as damage",
    archetype: "nature",
    maxHpScale: 0.15,
  },
  {
  ...
  },
  {
    ...
    desc: "7 데미지 × 2, 독 3",
    descJa: "7ダメージ×2・毒3",
    descEn: "Deal 7 damage twice, poison 3",
    archetype: "meka",
    damage: 7,
    multiHit: 2,
    poison: 3,
  ...
  },
  {
    ...
    type: "attack",
    rarity: "rare",
    desc: "방어력 절반만큼 피해, 방어력 +2",
    descJa: "防御力半分ダメージ・防御力+2",
    descEn: "Deal half-armor damage, gain 2 armor",
    archetype: "tank",
    shieldStrike: 0.5,
    shield: 2,
  },
  ...
  },
  {
    ...
    desc: "잃은 HP만큼 데미지",
    descJa: "失ったHP分のダメージ",
    descEn: "Deal damage equal to missing HP",
    archetype: "warrior",
  ...
  },
  {
    ...
    desc: "6 데미지 × 3, 드로우 2",
    descJa: "6ダメージ×3・ドロー2",
    descEn: "Deal 6 damage three times, draw 2",
    archetype: "rogue",
    damage: 6,
    multiHit: 3,
    draw: 2,
  ...
  },
  {
    ...
    type: "skill",
    rarity: "epic",
    desc: "속박 2 (2턴 동안 적이 행동 불가)",
    descJa: "束縛2（2ターン行動不能）",
    descEn: "Bind 2 (enemy cannot act for 2 turns)",
    archetype: "cursed",
    bind: 2,
  },
  {
  ...
  },
  {
    ...
    type: "attack",
    rarity: "uncommon",
    desc: "3 데미지, 출혈 2, 화상 2",
    descJa: "3ダメージ・出血2・火傷2",
    descEn: "Deal 3 damage, bleed 2, burn 2",
    archetype: "cursed",
    damage: 3,
    bleed: 2,
    burn: 2,
